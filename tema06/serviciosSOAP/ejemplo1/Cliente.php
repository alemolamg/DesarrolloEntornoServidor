...
$wsdl = "http://localhost/DesarrolloEntornoServidor/tema06/serviciosSOAP/ejemplo1/Server.php?wsdl";
...
$respuestaSaludar = $client->call('Saludar', array('nombre' => "Pedro"));
echo $respuestaSaludar ." <br>";
$respuestaSuma = $client->call('Suma', array('a' => '7', 'b' => '8'));
echo "La suma es: ". $respuestaSuma ."<br>";
