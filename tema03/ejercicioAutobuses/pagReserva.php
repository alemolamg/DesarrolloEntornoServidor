...
?>
    <form action="" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="reservadas" id="reservadas" placeholder="Nº Plazas" min="1" max="<?php echo $viaje->Plazas_libres ?>">
    ...
    if ($_POST['reservadas'] > 0  && verifPlazas($conexion, $_POST['fecha'], $_POST['origen'], $_POST['destino'], $_POST["reservadas"])) {
